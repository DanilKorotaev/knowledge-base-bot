...
- [x] Реализовать получение активной сессии пользователя
- [x] Реализовать добавление сообщения пользователя в историю сессии
- [x] Реализовать проверку типа сессии (с контекстом базы знаний или без)
...
- [x] Реализовать отслеживание изменений в БД через `db.log_file_change()`
- [x] Реализовать отправку ответа пользователю с форматированием Markdown
- [x] Реализовать сохранение обоих сообщений (пользователя и ассистента) в БД
- [x] Реализовать синхронизацию изменений с NextCloud (если были изменения)
- [x] Реализовать обработку ошибок и таймаутов
- [x] Реализовать разбиение длинных ответов на части (если превышает лимит Telegram)
- [x] Обработать случай отсутствия активной сессии (автоматическое создание новой сессии)
