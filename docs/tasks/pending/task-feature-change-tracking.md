...
- [ ] Реализовать команду `/history` - показ истории изменений текущей сессии
- [ ] Реализовать команду `/revert [change_id]` - откат конкретного изменения
- [ ] Реализовать команду `/revert_session` - откат всех изменений сессии
- [ ] Реализовать форматированный вывод истории изменений
- [ ] Реализовать inline-кнопки для отката изменений в истории
- [ ] Реализовать подтверждение перед откатом (для безопасности)
