...
- [ ] Создать `services/sync_service.py`
- [ ] Реализовать метод `sync_to_nextcloud()` - синхронизация изменений в NextCloud
- [ ] Реализовать метод `sync_from_nextcloud()` - синхронизация изменений из NextCloud
- [ ] Реализовать метод `sync_file()` - синхронизация конкретного файла
- [ ] Реализовать метод `detect_conflicts()` - обнаружение конфликтов синхронизации
- [ ] Реализовать периодическую синхронизацию (через asyncio)
- [ ] Реализовать синхронизацию после изменений бота
- [ ] Реализовать обработку ошибок синхронизации
- [ ] Реализовать логирование операций синхронизации
- [ ] Реализовать команду `/sync` - принудительная синхронизация с NextCloud
- [ ] Реализовать уведомление пользователя о статусе синхронизации
- [ ] Реализовать обработку конфликтов (разрешение вручную или автоматически)
